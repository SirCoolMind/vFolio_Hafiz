...
<body class="theme-red">
  ...
  <div class="vg-page page-funfact" style="background-image: url({{ asset('assets/img/bg_banner.jpg') }});">
    <div class="container">
    ...
    <div class="container">
      ...
      <div class="gridder my-3">
        <div class="grid-item apps wow zoomIn">
          <div class="img-place" data-src="{{ asset('assets/img/work/work-1.jpg') }}" data-fancybox data-caption="<h5 class='fg-theme'>Mobile Travel App</h5> <p>Travel, Discovery</p>">
        ...
        <div class="grid-item template wireframes wow zoomIn">
          <div class="img-place" data-src="{{ asset('assets/img/work/work-2.jpg') }}" data-fancybox data-caption="<h5 class='fg-theme'>Music App</h5> <p>Musics</p>">
        ...
        <div class="grid-item apps ios wow zoomIn">
          <div class="img-place" data-src="{{ asset('assets/img/work/work-3.jpg') }}" data-fancybox data-caption="<h5 class='fg-theme'>Gaming Dashboard</h5> <p>Games, Streaming</p>">
        ...
        <div class="grid-item graphic ui-ux wow zoomIn">
          <div class="img-place" data-src="{{ asset('assets/img/work/work-4.jpg') }}" data-fancybox data-caption="<h5 class='fg-theme'>Drugs Delivery App</h5> <p>Health, Drugs</p>">
        ...
        <div class="grid-item apps ios wow zoomIn">
          <div class="img-place" data-src="{{ asset('assets/img/work/work-5.jpg') }}" data-fancybox data-caption="<h5 class='fg-theme'>Musics Discover</h5> <p>Musics, Dashboard</p>">
        ...
        <div class="grid-item graphic ui-ux wireframes wow zoomIn">
          <div class="img-place" data-src="{{ asset('assets/img/work/work-6.jpg') }}" data-fancybox data-caption="<h5 class='fg-theme'>Game Streaming</h5> <p>Games, Streaming</p>">
          ...
          <div class="owl-carousel testi-carousel">
            ...
            <div class="item">
              <div class="row">
                <div class="col-md-6">
                  <div class="img-place">
                    <img src="{{ asset('assets/img/testimonials/testimonials_2.jpg') }}" alt="">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="caption">
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6 col-lg-4 col-xl-3 item">
          <div class="img-place wow fadeInUp">
            <img src="{{ asset('assets/img/logo/company_1.svg') }}" alt="">
          </div>
        </div>
        <div class="col-md-6 col-lg-4 col-xl-3 item">
          <div class="img-place wow fadeInUp">
            <img src="{{ asset('assets/img/logo/company_2.svg') }}" alt="">
          </div>
        </div>
        <div class="col-md-6 col-lg-4 col-xl-3 item">
          <div class="img-place wow fadeInUp">
            <img src="{{ asset('assets/img/logo/company_3.svg') }}" alt="">
          </div>
        </div>
        <div class="col-md-6 col-lg-4 col-xl-3 item">
          <div class="img-place wow fadeInUp">
            <img src="{{ asset('assets/img/logo/company_4.svg') }}" alt="">
          </div>
        </div>
      </div>
      <div class="row">
        <div class="col-md-6 col-lg-4 col-xl-3 item">
          <div class="img-place wow fadeInUp">
            <img src="{{ asset('assets/img/logo/company_5.svg') }}" alt="">
          </div>
        </div>
        <div class="col-md-6 col-lg-4 col-xl-3 item">
          <div class="img-place wow fadeInUp">
            <img src="{{ asset('assets/img/logo/company_6.svg') }}" alt="">
          </div>
        </div>
        <div class="col-md-6 col-lg-4 col-xl-3 item">
          <div class="img-place wow fadeInUp">
            <img src="{{ asset('assets/img/logo/company_7.svg') }}" alt="">
          </div>
        </div>
        <div class="col-md-6 col-lg-4 col-xl-3 item">
          <div class="img-place wow fadeInUp">
            <img src="{{ asset('assets/img/logo/company_8.svg') }}" alt="">
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      ...
      <div class="row post-grid">
        <div class="col-md-6 col-lg-4 wow fadeInUp">
          <div class="card">
            <div class="img-place">
              <img src="{{ asset('assets/img/work/work-9.jpg') }}" alt="">
            </div>
            <div class="caption">
