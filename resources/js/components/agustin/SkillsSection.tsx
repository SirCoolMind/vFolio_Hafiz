...
export const SkillsSection: React.FC = () => {
  ...
  const categories = ["All", "Front-End", "Back-End & Engines", "Database & Storage", "DevOps & Tooling", "Core Competencies"];
        ...
        <div className="p-8 rounded-2xl border border-white/10 bg-white/[0.01]">
          ...
          <div className="flex flex-wrap gap-2">
            {[
              ...
              <span
                key={tag}
                className="px-3 py-1.5 rounded-lg text-xs font-mono bg-white/5 text-white/75 hover:bg-white/15 hover:text-white border border-white/10 transition-colors cursor-default"
              >
                {tag}
              </span>
            ))}
